...
let mk_thunkify_cu_init f =
  "-thunkify-compilation-unit-initialization", Arg.Unit f,
  " Initialize compilation units in a closure.\n\
  \     Used to reduce the size of the initialization function for wasm."
...
struct
  let list = [
    ...
    mk_thunkify_cu_init F._thunkify_cu_init;
    mk_config F._config;
